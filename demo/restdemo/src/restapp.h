...
namespace nap 
{
     ...
     * Rest Example application runs a simple REST server that has an "echo" RestFunction as API call
     * This application demonstrates a simple call to this REST API function using a RestClient
     * The function simply echo's the given required parameters as set in Napkin
     * Check the GUI code inside this apps update to see how a REST API call is made
     */
    ...
    private:
    	...
    	ObjectPtr<RestClient>		mRestClient = nullptr;			///< Pointer to rest client

    	// Rest call input parameters
    	int mIntInput = 42;
    	float mFloatInput = 3.14f;
    	std::string mStringInput = "HelloWorld!";
    	std::string mAddressString = "/echo";
